...
(function() {
     ...
     * @ngInject
     */
    var disableAllDirective = function disableAllDirective($timeout, $rootScope) {
        return {
            restrict: 'A',
            link: function (scope, element, attrs) {
                ...
                $rootScope.$on('tablesLoaded', function() {
                    $timeout(function() {
                        process();
                    });
                });
    ...
    disableAllDirective.$inject = ['$timeout', '$rootScope'];
    ...
    var disableElements = function(elements) {
        ...
        for (var i = 0; i < len; i++) {
            ...
            for (var j = 0; j < elements[i].attributes.length; j++) {
                ...
                if(atts.name === "skip-disable" && atts.value !== 'false'){
                    shouldDisable = false;
                    continue;
                }
            }
